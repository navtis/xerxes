...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_z3950_location, target_catalogue_url, target_description) VALUES(15, 0,'Victoria and Albert Museum (National Art Library)', 'V&amp;A', 'VANDA','vam', 'has.nal.vam.ac.uk:210/HORIZON','http://www.vam.ac.uk/page/n/national-art-library/','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_z3950_location, target_catalogue_url, target_description) VALUES(26, 1, 'Imperial College', 'Imperial', 'IC','imp', 'unicorn.lib.ic.ac.uk:2200/unicorn','http://www3.imperial.ac.uk/library','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_z3950_location, target_catalogue_url, target_description) VALUES(29, 1,'Institute of Education', 'Institute of Education', 'IOE','ioe', 'urd.sirsidynix.net.uk:7819/unicorn','http://www.ioe.ac.uk/services/4389.html','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_z3950_location, target_catalogue_url, target_description) VALUES(34, 1, 'Senate House', 'Senate House', 'SH','lon', 'consull.ull.ac.uk:210/INNOPAC','http://www.ull.ac.uk/','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_z3950_location, target_catalogue_url, target_description) VALUES(36, 1, 'School of African and Oriental Studies', 'SOAS', 'SOAS','soa', 'lib2.soas.ac.uk:210/INNOPAC','http://www.soas.ac.uk/library/','');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_z3950_location, target_catalogue_url, target_description) VALUES(37, 1, 'The Wellcome Library', 'Wellcome Library', 'WELLCOME','wel', 'libsys.wellcome.ac.uk:210/INNOPAC','http://library.wellcome.ac.uk/','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_z3950_location, target_catalogue_url, target_description) VALUES(41, 0, 'Royal Botanic Gardens, Kew', 'Kew Gardens', 'KEW','kew', '193.128.243.23:2200/PUBN','http://www.city.ac.uk/library/','');
