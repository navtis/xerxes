...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(2, 1, 'London School of Economics and Political Science', 'LSE', 'LSE', 'lse', '11', 'voyager-live.lse.ac.uk:7090/voyager','https://catalogue.lse.ac.uk', 1, 'http://catalogue.lse.ac.uk/Record/____', '');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(3, 1, 'University of Kent', 'Kent', 'KENT', '', '', 'nemesis.ukc.ac.uk:7090/voyager','https://catalogue.kent.ac.uk/', 1, 'https://catalogue.kent.ac.uk/Record/____', '');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(4, 1, 'The Open University in London', 'OU', 'OU', '', '', 'bulbul.open.ac.uk:7090/voyager','http://bulbul.open.ac.uk/',1,'http://voyager.open.ac.uk/vwebv/holdingsInfo?bibId=____', '');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(5, 0, 'University of the Arts, London', 'Arts', 'UOA','', '', 'voyager.arts.ac.uk:7090/voyager','http://www.arts.ac.uk/library/librarycatalogue/',1,'http://voyager.arts.ac.uk/vwebv/holdingsInfo?bibId=____','');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(6, 1, 'University College, London', 'UCL', 'UCL', 'ucl', '10', 'wallace.lib.ucl.ac.uk:9993/UCL01','http://www.ucl.ac.uk/library/main.shtml',1,'http://library.ucl.ac.uk/F?func=direct&#038;doc_number=____','');
#INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(6, 1, 'University College, London', 'UCL', 'UCL', 'ucl', '10', 'wallace.lib.ucl.ac.uk:9993/UCL01','http://www.ucl.ac.uk/library/main.shtml',1,'http://ucl-primo.hosted.exlibrisgroup.com/primo_library/libweb/action/display.do?doc=UCL_LMS_DS____&#038;vid=UCL_VU1','');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(7, 1, 'Royal Holloway, University of London', 'Royal Holloway', 'RHUL','', '', 'library.rhul.ac.uk:9991/roy01','http://www.rhul.ac.uk/library',1,'http://libserv4.rhul.ac.uk/F/?func=direct&#038;doc_number=____','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(15, 0,'Victoria and Albert Museum (National Art Library)', 'V&amp;A', 'VANDA','vam', '75', 'catalogue.nal.vam.ac.uk:210/HORIZON','http://www.vam.ac.uk/page/n/national-art-library/',0,'','');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(16 , 1, 'University of Middlesex', 'Middlesex', 'MIDDX','', '', 'mdx-lib-dc1.mdx.ac.uk:210/HORIZON','http://unihub.mdx.ac.uk/study/library/',0,'http://library.mdx.ac.uk/ipac20/ipac.jsp?full=3100001~!____~!0','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(32, 1, 'Brunel University', 'Brunel', 'BRUNEL','', '', 'library.brunel.ac.uk:2200/unicorn','http://www.brunel.ac.uk/services/library',0,'http://library.brunel.ac.uk/uhtbin/cgisirsi/0/UXBRIDGE/0/5?searchdata1=____','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(34, 1, 'Senate House', 'Senate House', 'SH','lon', '05', 'consull.ull.ac.uk:210/INNOPAC','http://www.ull.ac.uk/',0,'http://encore.ulrls.lon.ac.uk/iii/encore/record/C__R______','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(37, 1, 'The Wellcome Library', 'Wellcome Library', 'WELLCOME','wel', '22', 'libsys.wellcome.ac.uk:210/INNOPAC','http://library.wellcome.ac.uk/',0,'http://encore.wellcome.ac.uk/iii/encore/record/C__R______','');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(38, 1, 'South Bank University', 'South Bank', 'STHBANK', '', '', 'lispac.lsbu.ac.uk:210/INNOPAC','http://www.lsbu.ac.uk/library/',0,'http://encore.lsbu.ac.uk/iii/encore/record/C|R____|','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(43, 0, 'University of Roehampton', 'Roehampton', 'ROEH','', '', '194.80.240.19:5210/ADOP','http://www.roehampton.ac.uk/library/',0,'prism.talis.com/roehampton/items/____','');
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(44, 1, 'Kingston University', 'Kingston', 'KINGSTON','', '', '67.134.210.94:9991/PRIMO', 'http://www.kingston.ac.uk/informationservices/',0,'http://ku-primo-prod.hosted.exlibrisgroup.com/primo_library/libweb/action/display.do?fn=display&#038;vid=KU_VU1&#038;afterPDS=true&#038;doc=KU_LMS_DS____','');
...
INSERT INTO xerxes_pz2_targets (target_id, target_enabled, target_title_display, target_title_short, target_pz2_key, target_copac_key, target_copac_prefix, target_z3950_location, target_catalogue_url, target_has_opac_format, target_record_linkback, target_description) VALUES(1019, 1, 'University of Westminster (ULS)', 'Westminster (ULS)', 'WMINULS','', '', 'inform25.ac.uk:8000/WMIN','',0,'https://library-catalogue.westminster.ac.uk/F/?func=direct&#038;doc_number=____','');
